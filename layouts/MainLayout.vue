<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      <ul
        class="flex item-center justify-end text-xs text-[#333333] font-light px-2 h10 bg-[#FAFAFA] max-w-[1200px]"
      >
        ...
        <li class="px-3 hover:text-[#FF4646] cursor-pointer"> <Icon name="ic-sharp-install-mobile" size="17">App</Icon></li>
